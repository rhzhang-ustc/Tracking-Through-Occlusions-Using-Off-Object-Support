...
log_dir = 'test_logs'
model_name_suffix = 'mutual_16'
ckpt_dir = 'checkpoints_mutual_16'
num_worker = 12
...
def run_model(model, encoder, timestep, first_frame, rgbs, trajs, target_traj, valids, criterion, sw):
    # first_frame: B, C, H, W
...
def train():
    ...
    while global_step < max_iters:
        ...
        for i in range(S_out // 4 - 1):
            ...
            model_loss, ate, pred_traj_sub = run_model(model, encoder, frame_index,
                                                       rgbs[:, 0, :, :, :],
